...
public class MessageReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (JPushInterface.ACTION_REGISTRATION_ID.equals(intent.getAction())) {
            ...
            Log.d(TAG, "[MyReceiver] 接收到推送下来的自定义 " + bundle.getString(JPushInterface.EXTRA_MESSAGE));
            ...
            i.putExtra("url", "http://sports.qq.com/a/20160628/000537.htm");
            ...
            Log.d(TAG, "[MyReceiver] 用户点击打开了");
            //打开自定义的Activity
            String resultTag = bundle.getString(JPushInterface.EXTRA_EXTRA);
            if (!TextUtils.isEmpty(resultTag)) {
//				Gson gson = new Gson();
//				JpushBean jpushBean = gson.fromJson(resultTag, JpushBean.class);
...
//					if (content.equals("1")) {
//						intentMessage.setClass(context, SystemMessageActivity.class);
//						context.startActivity(intentMessage);
//					} else if (content.equals("2")) {
//						intentMessage.setClass(context, ActionMessageActivity.class);
//						context.startActivity(intentMessage);
//					} else if (content.equals("3")) {
//						intentMessage.setClass(context, ProfessionalMessageActivity.class);
//						context.startActivity(intentMessage);
//					}
            }
