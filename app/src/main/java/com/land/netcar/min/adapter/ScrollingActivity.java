...
public class ScrollingActivity extends BaseActivity2 {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        iv_shuxin.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                snackbar = Snackbar.make(view, "搜索蓝牙中...", Snackbar.LENGTH_LONG)
                        .setAction("Action", null);
                snackbar.show();
                if (iv_shuxin.getAnimation() == null) {
                    startAnimation(iv_shuxin);
                    openBluetooth();
                }
